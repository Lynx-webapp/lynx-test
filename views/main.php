...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <!-- Navbar -->
  <!-- Jumbotron -->
  <div class="p-5 text-center" style="width: 36rem;">
    <h1 class="mb-4">Lynx</h1>
    <h4 class="mb-3">Est une application web qui vous permet créer des groupes avec des amis, créer des serveurs, parler avec vos amis, etc... </h4>
  </div>
  <!-- Jumbotron -->
</header>
